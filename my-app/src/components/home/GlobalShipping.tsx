          ...
          {regions.map((region) => (
            ...
            >
              <div className="flex items-center mb-4">
                <MapPin className="h-6 w-6 text-primary-accent mr-3" />
                <h3 className="font-heading font-semibold text-headings">
                  {region.name}
                </h3>
              </div>
              ...
              <div className="flex items-center text-sm text-primary-accent font-medium">
